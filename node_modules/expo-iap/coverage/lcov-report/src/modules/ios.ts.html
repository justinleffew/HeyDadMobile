    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>86/91</span>
            </div>
...
<span class="cstat-no" title="statement not covered" >  return !!(await ExpoIapModule.canPresentExternalPurchaseNoticeIOS());</span>
};
&nbsp;
/**
...
&gt; = <span class="fstat-no" title="function not covered" >async </span>() =&gt; {
  const result = <span class="cstat-no" title="statement not covered" >await ExpoIapModule.presentExternalPurchaseNoticeSheetIOS();</span>
<span class="cstat-no" title="statement not covered" >  return result as ExternalPurchaseNoticeResultIOS;</span>
};
&nbsp;
/**
...
&gt; = <span class="fstat-no" title="function not covered" >async </span>(url: string) =&gt; {
  const result = <span class="cstat-no" title="statement not covered" >await ExpoIapModule.presentExternalPurchaseLinkIOS(url);</span>
<span class="cstat-no" title="statement not covered" >  return result as ExternalPurchaseLinkResultIOS;</span>
};
&nbsp;
