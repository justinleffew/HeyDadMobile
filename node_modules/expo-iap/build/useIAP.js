...
export function useIAP(options) {
    ...
    const initIapWithSubscriptions = useCallback(async () => {
        ...
        const config = optionsRef.current?.enableBillingProgramAndroid ||
